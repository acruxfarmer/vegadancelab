...
export function createApplicationApi(env,store,fetcher=fetch){
 ...
 return async(req,res)=>{
  ...
  try{
   ...
   const body=await readJson(req),routes={'/api/credits/issue':'issue-credit','/api/classes/policy':'class-policy','/api/reservations':'reserve','/api/classes':'class','/api/participants':'participant','/api/preferences':'preferences','/api/notifications':'notification'};
